  ...
  return (
    <section className="px-10 py-18 pt-75 space-y-30">
      <div className="space-y-10">
        ...
        <p className="text-2xl text-deep-charcoal text-normal tracking-[-0.005em]! leading-[150%] max-w-160">
      ...
      <div className="border border-ocean/20 bg-white p-10">
        <div className="grid grid-cols-2 md:grid-cols-10 md:gap-y-0 gap-y-2">
          ...
          <div className="md:col-span-8 text-base font-normal text-deep-charcoal/60 py-4 md:pl-12">
            Why it is happening
          </div>

          {/* Row 1: Time */}
          <div className="md:col-span-2 py-4 flex md:items-center gap-2 text-base font-normal text-deep-charcoal md:border-r border-ocean/20">
          ...
          <div className="md:col-span-8 py-4 md:pl-12  text-base font-normal text-deep-charcoal">
            Admin, reporting, and manual research consume hours
          </div>

          {/* Row 2: Intelligence */}
          <div className="md:col-span-2 py-4 flex d:items-center gap-2 text-base font-normal text-deep-charcoal md:border-r border-ocean/20">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Row 4: Leverage */}
          <div className="md:col-span-2 py-4 md:py-6 flex d:items-center gap-2 text-base font-normal text-deep-charcoal md:border-r border-ocean/20">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
