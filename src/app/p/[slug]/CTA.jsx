...
export default function CTA({ activeTab, page }) {
  ...
  return (
    <section
      className="bg-ocean bg-[linear-gradient(115.42deg,#6A949D_37.48%,#99BBC1_100%)] bg-cover bg-center bg-no-repeat px-10 py-20 pt-75 gap-20 relative"
    >
      ...
      <AppearOnView key={`cta-top-${activeTab}`} as="div" animation="up" delay={20} className="relative z-10">
      ...
      <div className="pt-25 space-y-16 sm:space-y-30 md:space-y-50 lg:space-y-95 relative z-10">
        <AppearOnView as="div" animation="up" delay={120} className='space-y-4 sm:space-y-8 md:space-y-15'>
          ...
          <AppearOnView as="div" animation="up" delay={190} className="inline-flex">
            <a
