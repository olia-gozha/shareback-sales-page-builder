    ...
    <section className="bg-deep-charcoal px-10 py-20 pt-75 space-y-20">
        ...
        <div className="border border-ghost/10 p-10">
          <div className="grid grid-cols-2 md:grid-cols-10 md:gap-y-0 gap-y-2">
            ...
            {/* Row 1: Time */}
            <div className="md:col-span-2 py-4 flex md:items-center gap-2 text-base font-normal text-ghost md:border-r border-ghost/10">
            ...
            {/* Row 4: Leverage */}
            <div className="md:col-span-2 py-4 md:py-6 flex d:items-center gap-2 text-base font-normal text-ghost md:border-r border-ghost/10">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
