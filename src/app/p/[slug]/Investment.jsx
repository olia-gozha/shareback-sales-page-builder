...
export default function Investment({ page = {} }) {
  const people = page.investment_people || 0
  const price = page.investment_price || 0
    ...
    <section className="bg-white px-10 py-20 pt-75 space-y-20">
      <AppearOnView as="div" animation="up" delay={20} className="space-y-10">
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          <AppearOnView as="div" animation="up" delay={90} className="border border-ocean/20 p-13 flex flex-col items-center justify-center">
          ...
          <AppearOnView as="div" animation="up" delay={130} className="border border-ocean/20 bg-white p-12 flex flex-col items-center justify-center">
            <div className="text-center text-[5rem] md:text-[6rem] lg:text-[7rem] leading-none font-serif tracking-tight text-deep-charcoal">
              {'\u00A3'}{price}
            </div>
            <div className="text-base text-deep-charcoal/60">
          ...
          <AppearOnView as="div" animation="up" delay={170} className="bg-[#DAEAEE] p-12 flex flex-col items-center justify-center">
            <div className="text-center text-[5rem] md:text-[6rem] lg:text-[7rem] leading-none font-serif tracking-tight text-deep-charcoal">
      ...
      <AppearOnView as="div" animation="up" delay={220} className="space-y-10">
        <h3 className="text-xl font-normal leading-none text-deep-charcoal/40 tracking-[-0.005em]!">Includes</h3>
        <ul className="space-y-3">
          {features.map((feature, index) => (
            <AppearOnView key={index} as="li" animation="up" delay={280 + index * 35} className="flex items-center text-deep-charcoal text-base tracking-[-0.02em]! leading-[150%]">
              <svg
      ...
      <AppearOnView as="hr" animation="up" delay={260} className="border-t border-ocean/20 w-full mb-20 md:mb-28" />

      <AppearOnView as="div" animation="up" delay={320} className="space-y-10 py-10">
